...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>编辑优惠券</span></div>
	...
	<form method="post" action="<?php echo url('home/shops/save_delivery'); ?>" enctype="multipart/form-data">
		...
		优惠券名称：<input type="text" name="delivery_name" value="<?php echo $list['discount_name']; ?>"><br />
		优惠券数量：<input type="text" name="delivery_num" value="<?php echo $list['discount_num']; ?>"><br />
		最低消费：	 <input type="text" name="delivery_consume" value="<?php echo $list['discount_consume']; ?>"><br />
		优惠金额：<input type="text" name="delivery_value" value="<?php echo $list['discount_value']; ?>"><br />
		优惠券图片：
		...
		<img src="" id="show_img">
		<input type="hidden" name="delivery_img" id="delivery_img" value="<?php echo $list['discount_img']; ?>">
		<br />
