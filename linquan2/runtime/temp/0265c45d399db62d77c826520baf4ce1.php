<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\finance\list.html";i:1495611396;s:53:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\base.html";i:1490867328;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
	...
	<div id="shops" tabId="shops" title="财务明细" class='wst-tab' style="height: 99%">
		<div class="wst-toolbar">
			...
			<select name="s2_types" id="s2_types" class="s2_ipt">
				...
				<?php if(is_array($res1) || $res1 instanceof \think\Collection): $i = 0; $__LIST__ = $res1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <input type="hidden" />
	    ...
	    <p class="biaoge_p biaoge_p1">
	    	...
	    	<select id="operator" name="operator" class="iptb1">
	    		...
	    		<?php if(is_array($operator) || $operator instanceof \think\Collection): $i = 0; $__LIST__ = $operator;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?>
				<option value="<?php echo $vos['staffId']; ?>"><?php echo $vos['staffName']; ?></option>
				<?php endforeach; endif; else: echo "" ;endif; ?>
	    	</select>
	    	<span style="width: 330px;float: right;">
...
<script src="__ADMIN__/finance/echarts.js?v=<?php echo $v; ?>" type="text/javascript"></script>
