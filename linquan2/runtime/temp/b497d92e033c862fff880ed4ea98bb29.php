<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\phpStudy\WWW\linquan2\addons\auction\view\admin/list.html";i:1494065166;s:82:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\admin\view\base.html";i:1490867328;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div id="wst-tabs" style="width:100%; height:99%;overflow: hidden; border: 1px solid #D3D3d3;" class="liger-tab">
   <div title="拍卖商品" class='wst-tab'  style="height: 99%">
		...
		商品：<input type="text" name="goodsName1"  placeholder='商品名称' id="goodsName1" class='j-ipt'/>
   ...
   <div title="待审核商品" class='wst-tab'  style="height: 99%">
		...
		商品：<input type="text" name="goodsName2"  placeholder='商品名称' id="goodsName2" class='j-ipt'/>
...
<script src="__ROOT__/addons/auction/view/admin/list.js?v=<?php echo $v; ?>" type="text/javascript"></script>
