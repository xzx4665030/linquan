	...
	<form method="post" id="payform" autocomplete="off">
        ...
        <?php if(($data['payPwd'])): ?>
           <tr>
             ...
             <td>
             <input type='password' class="ipt" id='oldPass' name='oldPass' <?php if(($data['payPwd'])): ?>data-rule="原始支付密码: required;length(6)" data-msg-required="请填写原始支付密码" data-tip="请输入原始支付密码"<?php endif; ?> style='width:250px;' maxLength='6'/>
             </td>
           </tr>
        <?php endif; ?>
           <tr>
