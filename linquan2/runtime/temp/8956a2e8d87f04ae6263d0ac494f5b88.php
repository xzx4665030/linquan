...
<div class="wst-regist-b">
	...
	<input type="hidden" id="nameType" class="lqsj_ipt nameType" value='2' autocomplete="off"/>
	...
	<table class="wst-table">
		<tr class="wst-login-tr">
			...
			<td><input id="loginName" name="loginName" class="lqsj_ipt wst-regist-input" tabindex="1" maxlength="30" autocomplete="off" onpaste="return false;" style="ime-mode:disabled;" placeholder="邮箱/用户名/手机号"  type="text" onkeyup="javascript:WST.isChinese(this,1)"/></td>
		</tr>
		<tr class="wst-login-tr">
			<td class="wst-regist-td"><font color='red'>*</font>密码</td>
			<td><input id="loginPwd" name="loginPwd" class="lqsj_ipt wst-regist-input" tabindex="2" style="ime-mode:disabled;" autocomplete="off" type="password" placeholder="6-16位字符"/></td>
		</tr>
		<tr class="wst-login-tr">
			<td class="wst-regist-td"><font color='red'>*</font>确认密码</td>
			<td><input id="reUserPwd" name="reUserPwd" class="lqsj_ipt wst-regist-input" tabindex="3" autocomplete="off" type="password" placeholder="6-16位字符"/></td>
		</tr>
		<tr id="mobileCodeDiv" class="wst-login-tr hide">
			<td class="wst-regist-td"><font color='red'>*</font>短信验证码</td>
			<td>
				<input maxlength="6" autocomplete="off" tabindex="6" class="lqsj_ipt wst-regist-codemo" name="mobileCode" style="ime-mode:disabled" id="mobileCode" type="text" data-target="#mobileCodeTips" placeholder="短信验证码"/>
		...
		<tr id="authCodeDiv" class="wst-login-tr">
			...
			<td>
				...
				<input id="verifyCode" style="ime-mode:disabled" name="verifyCode"  class="lqsj_ipt wst-regist-codein" tabindex="6" autocomplete="off" maxlength="6" type="text"  data-target="#verifyCodeTips" placeholder="验证码"/>
		...
		<tr class="wst-login-tr">
			<td colspan="2" style="padding-left:180px;">
				<label>
					<input id="protocol" name="protocol" type="checkbox" class="lqsj_ipt" value="1" data-rule="checked"/>我已阅读并同意
