...
<div class="help-box">
	...
	<div class="help-right">
		<div class="h-content">
			...
			<ul class="news-list">
				<?php if(is_array($newsList) || $newsList instanceof \think\Collection): $i = 0; $__LIST__ = $newsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?>
