...
<div class="wst-shop-info">
	...
	<div class="wst-shop-na">
		...
		<img src="__ROOT__/<?php echo $v['accredImg']; ?>" title='<?php echo $v['accredName']; ?>' alt='<?php echo $v['accredName']; ?>'>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
	...
	<div class="wst-shop-eva">
		...
		<?php $__FOR_START_3015__=0;$__FOR_END_3015__=$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_3015__;$i < $__FOR_END_3015__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_2888__=1;$__FOR_END_2888__=6-$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_2888__;$i < $__FOR_END_2888__;$i+=1){ ?>
	...
	<div class="wst-shop-eva">
		<p>时效评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_2110__=0;$__FOR_END_2110__=$data['shop']['scores']['timeScore'];for($i=$__FOR_START_2110__;$i < $__FOR_END_2110__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_27519__=1;$__FOR_END_27519__=6-$data['shop']['scores']['timeScore'];for($i=$__FOR_START_27519__;$i < $__FOR_END_27519__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
	<div class="wst-shop-eva">
		<p>服务评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_2981__=0;$__FOR_END_2981__=$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_2981__;$i < $__FOR_END_2981__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_20899__=1;$__FOR_END_20899__=6-$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_20899__;$i < $__FOR_END_20899__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
...
<div class="wst-shop-split"></div>
<div class="wst-shop-jrdt">
	<div class="wst-title">今日动态</div>
	<div>
	    <div class='item'>
			<div class='icon1'></div>
			<div class='title'>待查看消息数<br/><span class='num'><?php echo $data['stat']['messageCnt']; ?></span></div>
		</div>
		<div class='item'>
			<div class='icon2'></div>
			<div class='title'>今日销售金额<br/><span class='num'><?php echo $data['stat']['saleMoney']; ?></span></div>
		</div>
		<div class='item'>
			<div class='icon3'></div>
			<div class='title'>今日订单数<br/><span class='num'><?php echo $data['stat']['orderCnt']; ?></span></div>
		</div>
		<div class='item'>
			<div class='icon4'></div>
			<div class='title'>待发货订单<br/><span class='num'><?php echo $data['stat']['waitDeliveryCnt']; ?></span></div>
		</div>
		<div class='item'>
			<div class='icon5'></div>
			<div class='title'>库存预警<br/><span class='num'><?php echo $data['stat']['stockWarnCnt']; ?></span></div>
		</div>
	</div>
</div>
<div class="wst-shop-spxx">
	<div class='wst-title'>商品信息</div>
	<div>
	    <div class='item'>
	    	<div class="rbox">
				<div class='icon1'></div>
			</div>
			<div class='title'>商品总数：<span class='num'><?php echo $data['stat']['goodsCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon2'></div>
			</div>
			<div class='title'>上架商品：<span class='num'><?php echo $data['stat']['onSaleCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon3'></div>
			</div>
			<div class='title'>待审核商品：<span class='num'><?php echo $data['stat']['waitAuditCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon4'></div>
			</div>
			<div class='title'>仓库中的商品：<span class='num'><?php echo $data['stat']['unSaleCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon5'></div>
			</div>
			<div class='title'>违规商品：<span class='num'><?php echo $data['stat']['illegalCnt']; ?></span></div>
		</div>
	</div>
</div>
<div class="wst-shop-ddxx">
	<div class='wst-title'>订单信息</div>
	<div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon1'></div>
			</div>
			<div class='title'>待付款订单：<span class='num'><?php echo $data['stat']['orderNeedpayCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon2'></div>
			</div>
			<div class='title'>待发货订单：<span class='num'><?php echo $data['stat']['waitDeliveryCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon3'></div>
			</div>
			<div class='title'>待结束订单：<span class='num'><?php echo $data['stat']['orderWaitCloseCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon4'></div>
			</div>
			<div class='title'>待退款订单：<span class='num'><?php echo $data['stat']['orderRefundCnt']; ?></span></div>
		</div>
		<div class='item'>
	    	<div class="rbox">
				<div class='icon5'></div>
			</div>
			<div class='title'>待评价订单：<span class='num'><?php echo $data['stat']['orderWaitAppraisesCnt']; ?></span></div>
		</div>
	</div>
</div>
