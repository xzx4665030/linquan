...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>添加满减送</span></div>
	...
	<form method="post" action="<?php echo url('home/shops/save_delivery'); ?>" enctype="multipart/form-data">
		满减送有效期：<input type='text' class="laydate-icon j-ipt" id='startDate' onclick="laydate()" value='<?php echo $startDate; ?>' name="startDate"/>至
