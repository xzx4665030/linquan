...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>添加红包</span></div>
  
	<form method="post" action="<?php echo url('home/shops/save_redPacket'); ?>" enctype="multipart/form-data">
		红包有效期：<input type='text' class="laydate-icon j-ipt" id='startDate' onclick="laydate()" value='<?php echo $startDate; ?>' name="startDate"/>至
		<input type='text' class="laydate-icon j-ipt" id='endDate' onclick="laydate()" value='<?php echo $endDate; ?>' name="endDate"/><br />
		红包名称：<input type="text" name="redPacket_name"><br />
		红包数量：<input type="text" name="redPacket_num"><br />
		红包金额：<input type="text" name="redPacket_value"><br />
		红包图片：
		...
		<img src="" id="show_img">
		<input type="hidden" name="redPacket_img" id="redPacket_img">
		<br />
