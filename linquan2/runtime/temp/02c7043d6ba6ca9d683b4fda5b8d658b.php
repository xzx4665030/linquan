...
<div class="wst-wrap">
  ...
  <div class='wst-user-content'>
    <?php if(is_array($data) || $data instanceof \think\Collection): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if((empty($vo['appraise']))): ?>
    ...
    <div class="appraise-box">
      ...
      <div class="o-goods-info">
        <img src="__ROOT__/<?php echo $vo['goodsImg']; ?>" title="商品名称"  />
        <p class="o-goodsName" title="<?php echo $vo['goodsName']; ?>"><?php echo $vo['goodsName']; ?></p>
    ...
    <div class="appraise-complate">
      ...
      <div class="appraise-area">
                <div class="appraise-item">
                  <div class="appraise-title">商品评分：</div>
                  <div class="appraise-content">
                    <?php $__FOR_START_27563__=0;$__FOR_END_27563__=$vo['appraise']['goodsScore'];for($i=$__FOR_START_27563__;$i < $__FOR_END_27563__;$i+=1){ ?>
               ...
               <div class="appraise-item">
                    <div class="appraise-title"> 时效评分：</div>
                    <div class="appraise-content">
                       <?php $__FOR_START_9639__=0;$__FOR_END_9639__=$vo['appraise']['timeScore'];for($i=$__FOR_START_9639__;$i < $__FOR_END_9639__;$i+=1){ ?>
                        <img src="__STATIC__/plugins/raty/img/star-on-big.png">
                        <?php } ?>
                    </div>
               </div>
               ...
               <div class="appraise-item">
                  <div class="appraise-title">服务评分：</div>
                  <div class="appraise-content">
                      <?php $__FOR_START_15042__=0;$__FOR_END_15042__=$vo['appraise']['serviceScore'];for($i=$__FOR_START_15042__;$i < $__FOR_END_15042__;$i+=1){ ?>
                        <img src="__STATIC__/plugins/raty/img/star-on-big.png">
                      <?php } ?>
                  </div>
               </div>
               ...
               <div class="appraise-item">
                  ...
                  <div class="appraise-content">
                    ...
                    <?php if(is_array($vo['appraise']['images']) || $vo['appraise']['images'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['appraise']['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;if(!empty($img)): ?>
                      <img src="__ROOT__/<?php echo str_replace('.','_thumb.',$img); ?>" layer-src="__ROOT__/<?php echo $img; ?>" width="75" height="75" />
...
<script type="text/javascript" src="__STATIC__/plugins/raty/jquery.raty.min.js?v=<?php echo $v; ?>"></script>
...
var options = {
  ...
  <?php if(is_array($data) || $data instanceof \think\Collection): $key1 = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($key1 % 2 );++$key1;?>
