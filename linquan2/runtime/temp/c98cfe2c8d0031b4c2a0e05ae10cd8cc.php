<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:67:"D:\phpStudy\WWW\linquan2\addons\groupon\view\home/index/detail.html";i:1490601784;s:89:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\base.html";i:1490282008;s:95:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\header_top.html";i:1491364219;s:95:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\shop_apply.html";i:1491364219;s:91:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\header.html";i:1490953514;s:95:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\right_cart.html";i:1490282866;s:91:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\footer.html";i:1491364219;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php echo $goods['goodsName']; ?> - 团购商品 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<meta name="Keywords" content="<?php echo $goods['goodsSeoKeywords']; ?>,<?php echo $seoGrouponKeywords; ?>">

<link href="__STYLE__/css/common.css?v=<?php echo $v; ?>" rel="stylesheet">

<link href="__ROOT__/addons/groupon/view/home/index/css/goods.css?v=<?php echo $v; ?>" rel="stylesheet">
      ...
      <div class='intro'>
          ...
          <div class='summary'>
             ...
             <div class='item'>
               ...
               <div class='dd market-price' id='j-market-price'><em>￥</em><?php echo $goods['marketPrice']; ?></div>
             </div>
             <div class='item'>
               ...
               <div class='dd price' id='j-shop-price'>￥<?php echo $goods['grouponPrice']; ?></div>
               <div class='wst-clear'></div>
             </div>
             <div class='item'>
                <div class='dt'>商品评分：</div>
                <div class='dd'>
                  <?php $__FOR_START_24803__=0;$__FOR_END_24803__=$goods['scores']['totalScores'];for($i=$__FOR_START_24803__;$i < $__FOR_END_24803__;$i+=1){ ?>
                  <img src="__STATIC__/plugins/raty/img/star-on.png">
                  <?php } $__FOR_START_14599__=1;$__FOR_END_14599__=6-$goods['scores']['totalScores'];for($i=$__FOR_START_14599__;$i < $__FOR_END_14599__;$i+=1){ ?>
                  <img src="__STATIC__/plugins/raty/img/star-off.png">
                  <?php } ?>
                  <div class='appraise'>累计评价：<span class='appraise-num'><?php echo $goods['appraiseNum']; ?></span>
                  </div>
                </div>
             </div>
             <div class='item'>
          ...
          <div class='groupon-time-box'>
               <div class='dd' id='groupon-time' sc='<?php echo date("Y-m-d H:i:s"); ?>' sv='<?php echo $goods["startTime"]; ?>' ev='<?php echo $goods["endTime"]; ?>'>
          ...
          <div class='groupon-desc'>
          	...
          	<div class='dd'><?php echo $goods['grouponDesc']; ?></div>
          	<div class='wst-clear'></div>
          </div>
          <div class='spec'>
          ...
          <div class='buy'>
             <div class='item'>
                ...
                <div class='dd'>
	                ...
	                <input type='text' data-min='1' data-max='<?php echo $goods['grouponNum']; ?>' id='buyNum' class='buy-num' value='1' data-min='1' autocomplete="off" onkeyup='WST.changeIptNum(0,"#buyNum","#buy-reduce,#buy-add")' onkeypress="return WST.isNumberKey(event);" maxlength="3"/>
	                <a href='#none' class='buy-btn' id='buy-add' onclick='javascript:WST.changeIptNum(1,"#buyNum","#buy-reduce,#buy-add")'>+</a>
                    &nbsp; &nbsp;（商品库存：<span id='goods-stock'><?php echo $goods['grouponNum']; ?></span>&nbsp;<?php echo $goods['goodsUnit']; ?>，已团购<?php echo $goods['orderNum']; ?><?php echo $goods['goodsUnit']; ?>）
                </div>
             </div>
             <div class='item'>
                <div class='dt'>服务：</div>
             ...
             <div class='item' style='padding-left:75px;margin-top:20px;'>
               <?php if($goods['read'] || $goods['status']==-1 || $goods['status']==0): ?>
			...
			var jiathis_config = {
					url:  '<?php echo $shareInfo["link"]; ?>',
					title:'<?php echo $shareInfo["title"]; ?>',
					summary:'<?php echo $shareInfo["desc"]; ?>',
					imageUrl:'<?php echo $shareInfo["imgUrl"]; ?>',
					slide:{
						divid:'jiathis_main',
						pos:'left'
					}
...
<script>
var goodsInfo = {grouponId:<?php echo $goods['grouponId']; ?>,id:<?php echo $goods['goodsId']; ?>}
</script>
<script type='text/javascript' src='__STYLE__/js/cloudzoom.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript' src='__ROOT__/addons/groupon/view/home/index/js/time.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript' src='__ROOT__/addons/groupon/view/home/index/js/goods.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript' src='__STYLE__/js/qrcode.js?v=<?php echo $v; ?>'></script>
<script>
$(function(){
	var qr = qrcode(10, 'M');
