<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:65:"D:\phpStudy\WWW\linquan2\addons\auction\view\home/index/list.html";i:1488811252;s:89:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\base.html";i:1490282008;s:95:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\header_top.html";i:1493889699;s:95:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\shop_apply.html";i:1491364219;s:91:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\header.html";i:1490953514;s:95:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\right_cart.html";i:1494381492;s:91:"D:\phpStudy\WWW\linquan2\addons\auction\view\..\..\..\wstmart\home\view\default\footer.html";i:1493952747;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php echo $catName; ?> - 拍卖活动 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
<meta name="auther" content="WSTMart,www.wstmart.net" />
<meta name="copyright" content="Copyright©2016-2066 Powered By WSTMart" />

<meta name="description" content="<?php echo $seoAuctionDesc; ?>">
<meta name="Keywords" content="<?php echo $catName; ?>,<?php echo $seoAuctionKeywords; ?>">

<link href="__STYLE__/css/common.css?v=<?php echo $v; ?>" rel="stylesheet">

<link href="__ROOT__/addons/auction/view/home/index/css/list.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<input type="hidden" id="cat" class="sipt" value='<?php echo $auctionCatId; ?>'/>
<div class="auction-head">
   <div class="item" style="border-left:2px solid #df2003;padding-left: 8px;">
      <a class="link" href="/wstmartp2">首页</a>
      <i class="arrow">&gt;</i>
   </div>
      <div class="wst-lfloat" style='line-height: 22px;'>拍卖活动 </div>
      <div class="wst-clear"></div>
</div>
...
<div class="auction-selector">
    ...
    <li><a href="<?php echo addon_url('auction://goods/lists'); ?>" <?php if($auctionCatId==0): ?>class='curr'<?php endif; ?>>&nbsp;&nbsp;全部商品分类&nbsp;&nbsp;</a></li>
    <?php if(is_array($catList) || $catList instanceof \think\Collection): $i = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <li><a href="<?php echo addon_url('auction://goods/lists','catId='.$vo['catId']); ?>" <?php if($auctionCatId==$vo['catId']): ?>class='curr'<?php endif; ?>><?php echo $vo['catName']; ?></a></li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <div class="wst-clear"></div>
</div>
...
<div class="wst-container" id='auction-container' sc="<?php echo date('Y-m-d H:i:s'); ?>">
	<div class='goods-main'>
	   <div class="goods-list">
	      ...
	      <div class="goods <?php if($vo['status']==-1): ?>out<?php endif; ?>" sv="<?php echo $vo['startTime']; ?>" ev="<?php echo $vo['endTime']; ?>">
	      	<div class="img"><a target='_blank' href="<?php echo addon_url('auction://goods/detail','id='.$vo['auctionId']); ?>"><img title="<?php echo $vo['goodsName']; ?>" alt="<?php echo $vo['goodsName']; ?>" class='goodsImg2' data-original="__ROOT__/<?php echo $vo['goodsImg']; ?>"/></a></div>
	      	<div class='goods-txt'>
	      	    <div class="p-name">
	      	    <a target='_blank' href="<?php echo addon_url('auction://goods/detail','id='.$vo['auctionId']); ?>"  title="<?php echo $vo['goodsName']; ?>"><?php echo $vo['goodsName']; ?></a>
	      	    </div>
	      		<div class='price-box'>
		      		<div class='price-txt'>当前价：</div>
		      		<div class='price'>￥<span class='font'><?php echo $vo['currPrice']; ?></span></div>
		      		<div class='num'><i></i><?php echo $vo['auctionNum']; ?>次出价</div>
	      		</div>
	      		<div class='wst-clear'></div>
...
<script type='text/javascript' src='__ROOT__/addons/auction/view/home/index/js/time.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript' src='__ROOT__/addons/auction/view/home/index/js/list.js?v=<?php echo $v; ?>'></script>
