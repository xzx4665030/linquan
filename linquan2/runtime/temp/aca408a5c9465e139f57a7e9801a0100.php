<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\mobile\item_1.html";i:1494579834;s:53:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\base.html";i:1490867328;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
            ...
            type: "post",
             ...
             success: function(data){
                if(data.res==1){
                  ...
                  $(".tp_sc").each(function(){
						if(($(this).width()/$(this).height()) > (640/240)){
						$(this).width(464);
					}else{
						$(this).height(142);
					}
