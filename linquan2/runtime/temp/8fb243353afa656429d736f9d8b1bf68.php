<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"D:\phpStudy\WWW\linquan2\addons\groupon\view\home/index/settlement.html";i:1489848072;s:89:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\base.html";i:1490282008;s:95:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\header_top.html";i:1491364219;s:95:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\shop_apply.html";i:1491364219;s:91:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\header.html";i:1490953514;s:91:"D:\phpStudy\WWW\linquan2\addons\groupon\view\..\..\..\wstmart\home\view\default\footer.html";i:1491364219;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>团购商品 -<?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
<meta name="auther" content="WSTMart,www.wstmart.net" />
<meta name="copyright" content="Copyright©2016-2066 Powered By WSTMart" />

<meta name="description" content="<?php echo WSTConf('CONF.seoGrouponDesc'); ?>">
<meta name="Keywords" content="<?php echo WSTConf('CONF.seoGrouponKeywords'); ?>">

<link href="__STYLE__/css/common.css?v=<?php echo $v; ?>" rel="stylesheet">

<link href="__ROOT__/addons/groupon/view/home/index/css/carts.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<?php if(!isset($_COOKIE['ads_cookie'])): $wstTagAds =  model("common/Tags")->listAds("index-top-ads",99,86400); foreach($wstTagAds as $key=>$tads){if(($tads['adFile']!='')): ?>
...
<div class="wst-container">
    ...
    <?php $shopFreight = 0;$freight = 0; $cartShops = $carts["carts"];$cartGoods = $cartShops['goods']; 
       if($carts['goodsType']==0 && !$cartShops['isFreeShipping']){
         if(!empty($userAddress)){
             ...
             $freight = WSTOrderFreight($cartShops['shopId'],-1);
             $shopFreight = $shopFreight + $freight;
         }
       }
     ?>
    ...
    <div class='cart-box2'>
       ...
       <div class='cart-item'>
          <div class='shop2'>
          <?php echo $cartShops['shopName']; if($cartShops['shopQQ'] !=''): ?>
          <a href="tencent://message/?uin=<?php echo $cartShops['shopQQ']; ?>&Site=QQ交谈&Menu=yes">
			  <img border="0" src="http://wpa.qq.com/pa?p=1:<?php echo $cartShops['shopQQ']; ?>:7" alt="QQ交谈" width="71" height="24"/>
		  </a>
          <?php endif; if($cartShops['shopWangWang'] !=''): ?>
          <a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=<?php echo $cartShops['shopWangWang']; ?>&siteid=cntaobao&status=1&charset=utf-8">
			  <img border="0" src="http://amos.alicdn.com/realonline.aw?v=2&uid=<?php echo $cartShops['shopWangWang']; ?>&site=cntaobao&s=1&charset=utf-8" alt="和我联系" />
		  </a>
          <?php endif; ?>
          </div>
          <div class='goods-list'>
             <div class='item selected'>
		        <div class='goods2'>
		            <div class='img2'>
		                <a href='<?php echo Url("home/goods/detail","id=".$cartGoods["goodsId"]); ?>' target='_blank'>
			            <img src='__ROOT__/<?php echo $cartGoods["goodsImg"]; ?>' width='80' height='80' title='<?php echo $cartGoods["goodsName"]; ?>'/>
			            </a>
		            </div>
		            <div class='name2'><?php echo $cartGoods["goodsName"]; ?></div>
		            <div class='spec2'></div>
		        </div>
		        <div class='price2'>¥<?php echo $cartGoods['shopPrice']; ?></div>
		        <div class='num2'><?php echo $cartGoods['cartNum']; ?></div>
		        <div class='t-price2'>¥<?php echo $cartGoods['shopPrice']*$cartGoods['cartNum']; ?></div>
		        <div class='wst-clear'></div>
             </div>
             <div class='shop-remark selected2'>
              订单备注：<input type='text' id="remark_<?php echo $cartShops['shopId']; ?>" class='j-ipt' style='width:700px;' maxLength='100' placeholder='给卖家留言'/>

             <div style="float: right;margin-top:-10px;">
             <p style="text-align:right;padding-right:13px;<?php if($carts['goodsType']==1): ?>display:none<?php endif; ?>" >
              <span style="text-align: right;line-height: 30px;">运费：<span id="shopF_<?php echo $cartShops['shopId']; ?>" style='font-weight: bold;color: #E55356;'>￥<?php echo $freight; ?></span></span>
            </p>
             <span style='text-align:right;line-height:30px;padding-right:13px;'>店铺合计<?php if($carts['goodsType']==0): ?>(含运费)<?php endif; ?>：<span id="shopC_<?php echo $cartShops['shopId']; ?>" v="<?php echo $cartShops['goodsMoney']; ?>" style='font-weight: bold;color: #E55356;'>￥<?php echo $freight+$cartShops['goodsMoney']; ?></span></span>
             </div>
    ...
    <div class="pay-boxs">
       ...
       <div class="wst-frame2" onclick='javascript:changeInvoice(1,"#invoiceClientDiv",this)'>需要开发票<i></i></div><br/><br/><br/>
       ...
       <div class='wst-clear'></div>
             ...
             <div>
             （共有<?php echo $userScore; ?>个积分，可抵¥<?php echo WSTScoreToMoney($userScore); ?>）
             <input type='checkbox' id='isUseScore' autocomplete="off" onclick='javascript:checkScoreBox(this.checked)' dataval="<?php echo $userScore; ?>"/>积分支付
             <span id='scoreMoney' style='display:none'>
             ，使用积分<input type="text" id="useScore" style="width:50px;margin-left:5px" class='j-ipt' onkeyup="javascript:WST.isChinese(this,1)" autocomplete="off" onkeypress="return WST.isNumberKey(event)" onblur="javascript:getCartMoney()" value="<?php echo $userScore; ?>"/>
             </span>
             ...
             <div <?php if(WSTConf('CONF.isOrderScore')!=1): ?>style='display:none'<?php endif; ?>>可获得积分：<span id='orderScore'><?php echo WSTMoneyGiftScore($carts["goodsTotalMoney"],0); ?></span>个</div>
             </div>
             <div class='wst-clear'></div>
          </div>         
       </div>
...
<script type='text/javascript' src='__ROOT__/addons/groupon/view/home/index/js/carts.js?v=<?php echo $v; ?>'></script>
