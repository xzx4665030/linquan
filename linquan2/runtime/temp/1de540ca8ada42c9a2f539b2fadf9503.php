<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpStudy\WWW\linquan2/wstmart/home\view\default\shops\promotion\edit_promotion.html";i:1492077394;s:66:"D:\phpStudy\WWW\linquan2/wstmart/home\view\default\shops\base.html";i:1490282234;s:66:"D:\phpStudy\WWW\linquan2/wstmart/home\view\default\header_top.html";i:1493889699;s:62:"D:\phpStudy\WWW\linquan2/wstmart/home\view\default\footer.html";i:1493952747;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>优惠券<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>编辑优惠券</span></div>
	...
	<form method="post" action="<?php echo url('home/shops/save_promotion'); ?>" enctype="multipart/form-data">
		优惠券有效期：<input type='text' class="laydate-icon j-ipt" id='startDate' onclick="laydate()" value='<?php echo date("Y-m-d",$list['discount_startDate']); ?>' name="startDate"/>至
		<input type='text' class="laydate-icon j-ipt" id='endDate' onclick="laydate()" value='<?php echo date("Y-m-d",$list['discount_endDate']); ?>' name="endDate"/><br />
		优惠券名称：<input type="text" name="promotion_name" value="<?php echo $list['discount_name']; ?>"><br />
		优惠券数量：<input type="text" name="promotion_num" value="<?php echo $list['discount_num']; ?>"><br />
		最低消费：	 <input type="text" name="promotion_consume" value="<?php echo $list['discount_consume']; ?>"><br />
		优惠金额：<input type="text" name="promotion_value" value="<?php echo $list['discount_value']; ?>"><br />
		优惠券图片：
		...
		<img src="" id="show_img">
		<input type="hidden" name="promotion_img" id="promotion_img" value="<?php echo $list['discount_img']; ?>">
		<br />
		<input type="hidden" name="promotion_flag" value="1">
		<input type="hidden" name="id" value="<?php echo $list['discount_id']; ?>">
