...
<div class='money-head'>
  ...
  <div class='shop-info'> 
     ...
     <div class='shopMoney'>可用资金：<font color='red' id='shopMoney'>¥0</font><a id='drawBtn' href='javascript:toDrawMoney()' style='margin-left:45px;'>申请提现</a><span class='draw-tips'>（至少￥<?php echo WSTConf('CONF.drawCashShopLimit'); ?>方可提现）</span></div>
     <div class="money-rows">
       <div class='shopMoney wst-lfloat'>冻结资金：<font color='red' id='lockMoney'>¥0</font></div>
     </div>
  </div>
</div>
