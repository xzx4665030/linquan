...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>编辑红包</span></div>
	...
	<form method="post" action="<?php echo url('home/shops/save_redPacket'); ?>" enctype="multipart/form-data">
		红包有效期：<input type='text' class="laydate-icon j-ipt" id='startDate' onclick="laydate()" value='<?php echo date("Y-m-d",$list['discount_startDate']); ?>' name="startDate"/>至
		...
		红包名称：<input type="text" name="redPacket_name" value="<?php echo $list['discount_name']; ?>"><br />
		红包数量：<input type="text" name="redPacket_num" value="<?php echo $list['discount_num']; ?>"><br />
		红包金额：<input type="text" name="redPacket_value" value="<?php echo $list['discount_value']; ?>"><br />
		红包图片：
		...
		<img src="" id="show_img">
		<input type="hidden" name="redPacket_img" id="redPacket_img" value="<?php echo $list['discount_img']; ?>">
		<br />
