...
<div class="wst-wrap">
  ...
  <div class="wst-shop-head"><span>已发货调拨订单</span></div>
    ...
    <table class='wst-order-list'>
       ...
       <tbody class="j-order-row {{#if(d[i].payType==1){}}j-warn{{#} }}">
         ...
         <tr class='goods-box'>
            ...
            <td rowspan="{{rows}}">
                <div><a target='blank' href='{{WST.U("home/call/receive_call","id="+d[i].call_id)}}'>【确认收货】</a></div>
                <div><a href='#none' onclick='view({{d[i].call_id}})'>【订单详情】</a></div>
            </td>
            {{#}}}
         </tr>
         {{# } }}
