...
<div class="wst-clear"></div>
   ...
   <tr id='tr_<?php echo $i; ?>' isLoad='1'>
     ...
     <div >
     <?php if($vo['img']!=''): ?>
            <img style="width:50px;height:50px;vertical-align: middle;" class="dsb"  src="/<?php echo $vo['img']; ?>">
     <?php else: ?>
