...
{{# for(var i = 0; i < d.length; i++){ }}
	<div class="wst-favo-shop">
		<div class="wst-favo-shopl">
			<a href="javascript:getShop({{ d[i].shopId }})" class="wst-favo-shopimg"><img class="shopsImg2" data-original="__ROOT__/{{ d[i].shopImg }}" title="{{ d[i].shopName }}"/></a>
			  ...
			  <div class="als-viewport">
				...
				{{# for(var a = 0; a < d[i].goods.length; a++){ }}
			      <li class="als-item wst-favo-goods">
					<div class="wst-favo-goodimg"><a href="javascript:getGoods({{ d[i].goods[a].goodsId }})"><img class="goodsImg2" data-original="__ROOT__/{{ d[i].goods[a].goodsImg }}" title="{{ d[i].goods[a].goodsName }}"/></a></div>
