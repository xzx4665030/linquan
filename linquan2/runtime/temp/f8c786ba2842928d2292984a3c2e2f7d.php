<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:73:"D:\phpStudy\WWW\linquan2\addons\distribut\view\home/index/goods_list.html";i:1490320130;s:91:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\base.html";i:1490282008;s:97:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\header_top.html";i:1491364219;s:97:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\shop_apply.html";i:1491364219;s:93:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\header.html";i:1490953514;s:97:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\right_cart.html";i:1490282866;s:93:"D:\phpStudy\WWW\linquan2\addons\distribut\view\..\..\..\wstmart\home\view\default\footer.html";i:1491364219;}*/ ?>
<!doctype html>
<head>
...
<link href="__ROOT__/addons/distribut/view/home/index/goodslist.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<div class='wst-filters'>
   ...
   <div class='wst-lfloat'>
     ...
     <div class="dorp-down-layer">
         ...
         <div class="<?php echo !empty($vo['parentId']) && $vo['parentId']>0?'cat2':'cat1'; ?>"><a href='<?php echo Url("addon/distribut-goods-glist","cat=".$vo2["catId"]); ?>'><?php echo $vo2['catName']; ?></a></div>
         <?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
	</div>
   </div>
   ...
   <div class='wst-lfloat'>
   	<div class='item dorpdown'>
     <div class='drop-down'>
        <a class='link' href='__ROOT__'>所有商品分类</a>
        <i class="drop-down-arrow"></i>
     </div>
     <div class="dorp-down-layer">
         <?php if(is_array($goodsCat) || $goodsCat instanceof \think\Collection): $i = 0; $__LIST__ = $goodsCat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
         <div class="<?php echo !empty($vo['parentId']) && $vo['parentId']>0?'cat2':'cat1'; ?>"><a href='<?php echo Url("addon/distribut-goods-glist","cat=".$vo2["catId"]); ?>'><?php echo $vo2['catName']; ?></a></div>
         <?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
	</div>
   ...
   <?php if(is_array($selector) || $selector instanceof \think\Collection): $i = 0; $__LIST__ = $selector;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
   <div class='item dorpdown'>
   <a class='v-item' href='javascript:void(0);' onclick="javscript:removeFilter('<?php echo $vo['type']; ?>')">
     <span><?php echo $vo['label']; ?>：<?php echo $vo['val']; ?></span>
     <i>x</i>
...
<script type='text/javascript' src='__ROOT__/addons/distribut/view/home/index/goodslist.js?v=<?php echo $v; ?>'></script>
