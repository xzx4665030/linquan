    ...
    <div class='pay-sbox'>
    	<div>
	   		<div style="padding-top: 50px;">
			    ...
			    <input type="text" class="j-ipt" id="needPay" value="1" maxlength="10" data-rule="充值金额:required;" onkeypress="return WST.isNumberKey(event)" onkeyup="javascript:WST.isChinese(this,1)" maxlength="8">
			    </div>
	    	</div><div></div>
		    <div>
			    ...
			    <div class="pay-list">
			    	...
			    	<?php if(is_array($payments) || $payments instanceof \think\Collection): $i = 0; $__LIST__ = $payments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($i % 2 );++$i;if($payment['isOnline'] == 1): ?>
