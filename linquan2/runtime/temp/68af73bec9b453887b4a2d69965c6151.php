...
<div class="wst-user-head"><span>绑定邮箱</span><a href="<?php echo url('home/users/security'); ?>">返回</a></div>
<div class="wst-clear"></div>
<?php if(($process=='One')): ?>
