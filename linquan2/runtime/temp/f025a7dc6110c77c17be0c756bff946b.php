...
<div class='score-head'>
  ...
  <div class='user-info'> 
     ...
     <div class='userScore'>可用资金：<font color='red' id='userMoney'>¥0</font><a id='drawBtn' href='javascript:toDrawMoney()' style='margin-left:45px;'>申请提现</a><span class='draw-tips'>（至少￥<?php echo WSTConf('CONF.drawCashUserLimit'); ?>方可提现）</span></div>
     <div class='userScore'>冻结资金：<font color='red' id='lockMoney'>¥0</font></div>
  </div>
</div>
        ...
        <table class='wst-list' style="font-size:13px;">
             ...
             {{# for(var i = 0; i < d.length; i++){ }}
                <tr>
                  ...
                  <td>{{ d[i].accUser }}</td>
                  <td>¥{{ d[i].money }}</td>
                  <td>{{#if(d[i].cashSatus==1){}}已通过{{#}else{}}待处理{{#}}}</td>
                </tr>
             {{# } }}
             </script>
