           ...
           <tr style="height:80px">
             ...
             <td>
              ...
              <div class="wst-lfloat shopbanner" <?php if(empty($object['shopBanner'])): ?>style='display:none'<?php endif; ?>>
                <img id="shopBannerPreview" class="lazyImg" height="100" style="max-width:500px;" src="__ROOT__/<?php echo $object['shopBanner']; ?>">
             ...
             <td>
                  ...
                  <div id="batchUpload" class="wst-batchupload" style="border:1px solid #ccc">
                    ...
                    <div class="queueList filled">
                        ...
                        <ul class="filelist" >
                            <?php if(is_array($object['shopAds']) || $object['shopAds'] instanceof \think\Collection): $i = 0; $__LIST__ = $object['shopAds'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
