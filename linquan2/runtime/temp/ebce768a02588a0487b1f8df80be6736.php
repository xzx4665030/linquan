<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\replenishment\list.html";i:1495185574;s:53:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\base.html";i:1490867328;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div id='expressBox' style='display:none'>
    ...
    <p class="biaoge_p">
    	...
    	<input type="hidden" class="ipt" name="isflag" id="isflag" value="" />
    	<span class="biaoti">补货数量<font color='red'>*</font>：</span>
    	<input type='text' id='buhuo_do_num' name="buhuo_do_num" disabled="disabled"  class='ipt changdu1' maxLength='20'/>
    </p>
    <p class="biaoge_p">
...
<script src="__ADMIN__/replenishment/logmoneys.js?v=<?php echo $v; ?>" type="text/javascript"></script>
