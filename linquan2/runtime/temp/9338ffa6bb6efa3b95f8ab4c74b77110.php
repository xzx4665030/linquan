    ...
    <div class='pay-sbox' >
    	<div class="balance-box">
	        ...
	        <div class="pbox">
	        	...
	        	<a class='pbox-tip' target='_blank' href='<?php echo url("home/users/editPayPass"); ?>'>忘记密码?</a>
	        </div>
	        <div class="pbox2">
