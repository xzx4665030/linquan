...
{{# for(var i = 0; i < d.length; i++){}}
	<div class="wst-fav-goods">
		<div class="wst-fav-goimg"><img class="goodsImg2" data-original="__ROOT__/{{ d[i].goodsImg }}" title="{{ d[i].goodsName }}"><span class="js-operate" onclick="javascript:cancelFavorite({{ d[i].favoriteId }},0)">取消收藏</div>
