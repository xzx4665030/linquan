<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\menus\list.html";i:1491358746;s:53:"D:\phpStudy\WWW\linquan2/wstmart/admin\view\base.html";i:1490867328;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<style>
body{padding:5px;}
#layout #sdsdsd{display: none;}
#layout .l-layout-left .l-layout-header{
	background-color: #3669d3;
	margin-bottom: 0px;
}
#layout .l-layout-header{
	height:48px ;
	line-height: 48px;
}
#layout .l-layout-center .l-layout-header{
	background-color: #97ade2;
}
</style> 
