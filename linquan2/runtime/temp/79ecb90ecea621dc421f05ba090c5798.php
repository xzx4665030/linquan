        ...
        <div class="wst-tab-item" style="position: relative;">
           <table class='wst-form'> 
			  ...
			  <tr>
			     ...
			     <td><?php echo $object['settlementNo']; ?></td>
			  </tr>
			  <tr>
			     <th>结算金额：</th>
			  ...
			  <tr>
			     <th>结算状态：</th>
			     <td>
			     <?php if($object['settlementStatus']==1): ?>
			     已结算
			     <?php else: ?>
			     待结算
			     <?php endif; ?>
			  ...
			  <tr>
			     <th>结算时间：</th>
			     <td><?php echo $object['settlementTime']; ?></td>
			  </tr>
			  <tr>
			     <th>结算备注：</th>
			     ...
			     <td colspan='2' align="center">
			     	<table class='wst-list' style='margin-left:5px;'>
		                ...
		                <tr>
		                   ...
		                   <td><?php echo WSTLangPayType($vo['payType']); ?></td>
		                   <td>¥<?php echo $vo['goodsMoney']; ?></td>
		                   <td>¥<?php echo $vo['deliverMoney']; ?></td>
		                   <td>¥<?php echo $vo['totalMoney']; ?></td>
		                   <td>¥<?php echo $vo['scoreMoney']; ?></td>
		                   <td>¥<?php echo $vo['realTotalMoney']; ?></td>
		                   <td>¥<?php echo $vo['commissionFee']; ?></td>
