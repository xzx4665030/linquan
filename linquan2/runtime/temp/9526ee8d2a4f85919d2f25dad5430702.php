    ...
    <table class='wst-list' style="font-size:13px;">
           ...
           <script id="top-sale-tblist" type="text/html">
              ...
              <tr>
    			...
    			<td>{{ d[i].goodsSn }}</td>
                <td>{{ d[i].goodsNum}}</td>
                <td><a target='_blank' href='{{WST.U("home/goods/detail","id="+d[i].goodsId)}}'>查看</a>
                </td>
              </tr>
    		  {{# } }}
    		  </script>
