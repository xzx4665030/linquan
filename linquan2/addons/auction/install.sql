insert into lqsj_datas(catId,dataName,dataVal) values(6,'拍卖商品审核通过','AUCTION_GOODS_ALLOW'),
...
insert into `lqsj_template_msgs`(tplType,tplCode,tplContent,tplDesc) values
...
CREATE TABLE `lqsj_auction_moneys` (
...
CREATE TABLE `lqsj_auction_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `lqsj_crons`(cronName,cronCode,isEnable,cronJson,cronUrl,cronDesc,cronCycle,cronDay,cronWeek,cronHour,cronMinute,runTime,nextTime,author,authorUrl) VALUES ('完成拍卖', 'autoAuctionEnd', '0', 'a:1:{i:0;a:3:{s:10:\"fieldLabel\";s:21:\"每次执行记录数\";s:9:\"fieldCode\";s:7:\"cronNum\";s:8:\"fieldVal\";s:1:\"5\";}}', 'addon/auction-auction-scanTask.html', '将到期的拍卖活动结束并计算出拍卖胜出者', '2', '9', '4', '-1', '0,5,10,15,20,25,30,35,40,45,50,55', '2017-03-10 16:05:59', '2017-03-10 16:10:00', 'WSTMart', 'http://www.wstmart.net');

INSERT INTO `lqsj_navs`(navType,navTitle,navUrl,isShow,isOpen,navSort,createTime) VALUES ('0', '拍卖活动', 'index.php/addon/auction-goods-lists.html', '1', '0', '0', '2017-02-25 10:32:01');