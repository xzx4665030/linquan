insert into lqsj_datas(catId,dataName,dataVal) values(6,'团购商品审核通过','GROUPON_GOODS_ALLOW'),
(6,'团购商品审核不通过','GROUPON_GOODS_REJECT'),
(9,'团购商品审核通过','WX_GROUPON_GOODS_ALLOW'),
(9,'团购商品审核不通过','WX_GROUPON_GOODS_REJECT');
insert into `lqsj_template_msgs`(tplType,tplCode,tplContent,tplDesc) values(0,'GROUPON_GOODS_ALLOW','您的团购商品${GOODS}【${GOODS_SN}】已审核通过。','1.变量说明：${GOODS}：商品名称。${GOODS_SN}：商品编号。${TIME} ：当前时间。<br/>2.为空则不发送。'),
...
INSERT INTO `lqsj_navs`(navType,navTitle,navUrl,isShow,isOpen,navSort,createTime) VALUES ('0', '团购活动', 'index.php/addon/groupon-goods-lists.html', '1', '0', '0', '2017-02-16 10:32:01');