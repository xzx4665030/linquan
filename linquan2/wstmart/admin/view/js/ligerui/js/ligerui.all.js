...
*
* vn:d9e17d4fabb51df69c10aab6b42bd031
* 
*/
(function ($)
{
...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        setHeight: function (height)
        {
            ...
            $("> .l-accordion-content", g.accordion).height(height-10);
        }
    });
        ...
        */
        ...
        _initColumns: function ()
        {
            ...
            function setColumn(column, level, pid, previd)
            {
                ...
                column['__domid'] = g.id  + column['__id'];
