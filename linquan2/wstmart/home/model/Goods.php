...
class Goods extends CGoods{
	...
	*/
	...
	public function stockByPage(){
		...
		$prefix = config('database.prefix');
		$sql1 = 'SELECT g.is_transfer,g.goodsId,g.goodsName,g.goodsType,g.goodsImg,gs.specStock goodsStock ,gs.warnStock warnStock,g.isSpec,gs.productNo,gs.id,gs.specIds,g.isSale
		...
		$sql2 = 'SELECT g.is_transfer,g.goodsId,g.goodsName,g.goodsType,g.goodsImg,g.goodsStock,g.warnStock,g.isSpec,g.productNo,0 as id,"" as specIds,g.isSale
                    FROM '.$prefix.'goods g 
