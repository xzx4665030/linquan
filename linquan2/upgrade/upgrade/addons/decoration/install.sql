DROP TABLE IF EXISTS `lqsj_shop_decoration_blocks`;
CREATE TABLE `lqsj_shop_decoration_blocks` (
...
DROP TABLE IF EXISTS `lqsj_shop_decorations`;
CREATE TABLE `lqsj_shop_decorations` (
...
alter table `lqsj_shop_configs` add userDecoration tinyint(4) default 0;;