insert into `lqsj_datas`(catId,dataName,dataVal) values(6,'砍价商品审核通过','BARGAIN_GOODS_ALLOW'),
...
CREATE TABLE `lqsj_bargain_helps` (
...
CREATE TABLE `lqsj_bargain_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bargainId` int(11) NOT NULL,
...
INSERT INTO `lqsj_ad_positions`(positionType,positionName,positionWidth,positionHeight,dataFlag,positionCode,apSort) VALUES ('2', '移动版砍价广告', '375', '188', '1', 'wx-ads-bargain', '1021');